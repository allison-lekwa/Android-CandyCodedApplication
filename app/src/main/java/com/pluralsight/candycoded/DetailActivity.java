...
public class DetailActivity extends AppCompatActivity {
    ...
    //implementing the createShareIntent method-->
    private void createShareIntent(){

        //create an shareIntent
        Intent shareIntent = new Intent(Intent.ACTION_SEND);
        shareIntent.setType("text/plain");

        //Create the string by concatenating individual strings
        String string = SHARE_DESCRIPTION + mCandyImageUrl + HASHTAG_CANDYCODED;

        //implementing the putExtra method of the intent
